...
public class Sqlite3Dao {
    ...
    //    private final Sqlite3Helper helper;
//    private volatile Sqlite3Helper helpers;
    //    public Sqlite3Dao(Context context) {
//        helper = new Sqlite3Helper(context);
//    }
...
//    }
//
//    public List<Law> getLaw(Integer categoryId) {
//        List<Law> result = new ArrayList<>();
//        try {
////            db = helper.getReadableDatabase();
//            result = importLaw(categoryId);
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
//            if (null != db) {
...
//    }
//
//    private List<Category> importCategory() {
//        Cursor category = db.rawQuery("SELECT * FROM category ORDER BY `order`", null);
//        List<Category> result = new ArrayList<>();
//        if (null != category) {
//            if (category.moveToFirst()) {
//                do {
...
//    }
//
//    private List<Law> importLaw(Integer categoryIds) {
//        Cursor law;
//        if (categoryIds != null) {
//            law = db.rawQuery("SELECT * FROM law WHERE category_id = ? ORDER BY `order`", new String[]{categoryIds.toString()});
//        } else {
//            law = db.rawQuery("SELECT * FROM law ORDER BY `order`", null);
//        }
//        List<Law> result = new ArrayList<>();
//        if (null != law) {
//            if (law.moveToFirst()) {
